...
@section('content')
    <div class='grid grid-cols-1 m-auto' style='background-image: url("img/bg.jpg");background-position: center center;
    ...
    <div class='sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 boder-b border-gray-200'>
        <div>
        ...
        <div class='m-auto sm:auto text-left w-4/5 block'>
            ...
            <p class='py-8 text-gray-500 text-l'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Volupatibus.</p>
            <p class='font-extrabold text-gray-600 text-l pb-9'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Volupatibus.Lorem ipsum dolor sit amet consectetur adipisicing elit. Volupatibus.
            </p>
    ...
    <div class='text-center p-15 bg-black text-white'>
        <h2 class='text-2xl pb-5 text-l'> I'm an extert in ..</h2>
    ...
    <div class='text-center py-15'>
        ...
        <p class='m-auto w-4/5 text-gray-500'>
            Lorem ipsum dolor site amet, consectetur adipisicing elip.
            Cumque exercitationem saepe enim veritatis, eos temporibus quaerat facere consectetur qui.
        </p>
    </div>
        ...
        <div class='flex bg-yellow-700 text-gray-100'>
            <div class='m-auto pt-4 pb-16 sm:m-auto w-4/5 block'>
                ...
                <h3 class='text-xl font-bold py-10'>
                    ...
                    Enim voluptas earum repudiandae consequuntur ad? Expedita labore aspernatur facilis quasi ex? Nemo hic placeat et?
                </h3>
